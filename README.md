...
This folder contains all data used within this study from both [aGC-DFT](./analytical_GC-DFT/data/aGC-DFT_data.csv) and [eGC-DFT](./analytical_GC-DFTdata/jdftx_data.csv) calculations, along with project density of states data for [pure metals](./gc-dft_analysis/data/pure_dos/) and [SAAs](./gc-dft_analysis/data/pure_dos/).
